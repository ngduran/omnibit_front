...
const Input = React.forwardRef(({ label, icon, className, error, isValid, type = "text", ...props }, ref) => {
  ...
  const styles = {
    ...
    // Ajusta o padding para acomodar o ícone à esquerda (se existir) e o ícone de olho à direita (se for password)
    padding: cn(
      icon ? "pl-11" : "pl-4",
